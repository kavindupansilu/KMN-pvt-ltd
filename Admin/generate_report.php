                                    ...
                                    if ($query) {
                                        if (mysqli_num_rows($query) > 0) {
                                            ...
                                            while ($row_report = mysqli_fetch_assoc($query)) {
                                                ...
                                                echo '<td>
                                                        <form action="report_delete.php" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="generate_report.php" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="Date_Generated" name="Date_Generated" required min="<?php echo date('Y-m-d'); ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="Service_Revenue">Service Revenue:</label>
                                        <input type="text" class="form-control" id="Service_Revenue" name="Service_Revenue" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        // Fetch item names and instock values from the Item table
                                        ...
                                        if ($itemResult && mysqli_num_rows($itemResult) > 0) {
                                            while ($item = mysqli_fetch_assoc($itemResult)) {
                                                ...
                                                echo '<label for="Parts_Sales_' . $item['Item_Name'] . '"> ' . $item['Item_Name'] . '</label>';
                                                echo '<span> InStock: ' . $item['InStock'] . '</span><br>';
                                            }
                                        }
                                        ?>
                                    </div>
                                    ...
                                    <button type="submit" class="btn btn-primary" name="generate_report_btn">Generate Report</button>     
