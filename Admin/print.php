...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(50, 7, "Colombo 07,Srilanka", 0, 1);
        $this->Cell(50, 7, "Fax : 025 567 8367", 0, 1);
        $this->Cell(50, 7, "Tel : 077 284 5678", 0, 1);
    ...
    
    {
        ...
        $this->SetX(-60);
        $this->SetFont('Arial', '', 12);
        $this->Cell(50, 7, $info["invoiceid"], 0, 1);
        $this->SetY(72);
        $this->SetX(-60);
        $this->Cell(50, 7, $info["invoice_date"], 0, 1);
        $this->SetY(79);
        $this->SetX(-60);
        $this->Cell(50, 7, $info["vehicleid"], 0, 1);
        ...
        foreach ($products_info as $row) {
            ...
            $this->Cell(40, 9, $row["typeservice"], "R", 0, "L");
