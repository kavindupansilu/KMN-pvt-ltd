...
if (isset($_POST['update_btn'])) {
    ...
    mysqli_stmt_bind_param($stmt, "sssssi", $formatted_service_date, $type_of_service, $parts_used, $elapsed_time, $total_cost, $edit_id);
                ...
                <div class="container-fluid center-form">
                    <div class="form-container">
                        ...
                        <form action="service_edit.php" method="post">
                            ...
                            <!-- Go Back Button -->
                            <a href="service.php" class="btn btn-secondary go-back-btn">Go Back</a>
                    </div>
                </div>
            </div>
        </div>
