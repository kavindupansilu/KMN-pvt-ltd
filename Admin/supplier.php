...
if (isset($_POST['add_supplier_btn'])) {
    ...
    // Validate Contact
    $contactPattern1 = "/^07[0124578][0-9]{7}$/"; // Starts with 07 and 2nd digit is 0,1,2,4,5,7,8
    ...
    if (mysqli_stmt_execute($stmt_add_supplier)) {
        ...
        $lastSupplierId = mysqli_insert_id($connect);
                            ...
                            <div class="modal-body">
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Contact" name="Contact" pattern="^(07[0124578][0-9]{7}|03[1237][0-9]{7})$" required>
