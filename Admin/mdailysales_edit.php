...
if (isset($_POST['update_btn'])) {
    ...
    $stmtTotalRevenue = mysqli_prepare($connect, $totalServiceRevenueQuery);
    ...
    if ($rowTotalRevenue = mysqli_fetch_assoc($resultTotalRevenue)) {
        ...
        $stmtUpdateSales = mysqli_prepare($connect, $updateSalesQuery);
    ...
    $update_query = "UPDATE sales 
                     SET Sales_Date=?, Parts_Sales=?, Service_Revenue=?
                     WHERE Sales_Id=?";
    $stmt = mysqli_prepare($connect, $update_query);
    mysqli_stmt_bind_param($stmt, "sssi", $sdate, $psales, $totalServiceRevenue, $edit_id);
            ...
            <div id="content">
                <div class="container-fluid center-form">
                    <div class="form-container">
                        ...
                        <form action="mdailysales_edit.php" method="post">
                            ...
                            <div class="form-group">
                                <label for="Parts_Sales">Parts Sales:</label>
