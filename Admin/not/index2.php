...
// Assuming you have a session variable named 'user_id' storing the active user's ID
$active_user_id = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : null;
                                ...
                                if ($result) {
                                    if (mysqli_num_rows($result) > 0) {
										...
										while ($row_payment = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo '<td>' . $row_payment['Address'] . '</td>';
									...
									echo '<td>
											<form action="invoice_delete.php" method="post">
