                                ...
                                if ($query_run_service) {
                                    if (mysqli_num_rows($query_run_service) > 0) {
                                        ...
                                        while ($row_service = mysqli_fetch_assoc($query_run_service)) {
                                            ...
                                            echo '<td>' . $row_service['Parts_Used'] . '</td>'; // Display parts used
                                            echo '<td>' . $row_service['Quantity'] . '</td>'; // Display quantities

                                            // // Calculate item cost based on quantity and display it
                                            // $itemCost = $row_service['Item_Cost'] * $row_service['Quantity'];
                                            // echo '<td>' . $itemCost . '</td>';
                                                ...
                                                <tbody>
                                                    ...
                                                    if ($itemResult && mysqli_num_rows($itemResult) > 0) {
                                                        while ($item = mysqli_fetch_assoc($itemResult)) {
                                                            ...
                                                            echo '<td><input type="number" name="Quantity_' . $item['Item_Name'] . '" id="Quantity_' . $item['Item_Name'] . '" min="0" onchange="updateItemCost(this)"></td>';
                                                            echo '</tr>';
                                                        }
                                                    }
                                                    ?>
