...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($password && $name && $phone && $email) {
        ...
        if (mysqli_query($connect, $insert_admin_query)) {
            ...
            // Update User_Id in the 'admin' table
            $update_user_id_query = "UPDATE admin SET User_Id ='$user_id' WHERE User_Id = '$last_id'";
            mysqli_query($connect, $update_user_id_query);

            // Insert data into the 'users' table
            $insert_users_query = "INSERT INTO users ( Password, Name, Phone, Email, User_Type) 
                                   VALUES ( '$password', '$name', '$phone', '$email', 'admin')";
...
<body>
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <a href="admin_login.php" class="btn btn-warning">Go to Login</a> <br>
        </form>
