...
if (isset($_POST['add_service_btn'])) {
    ...
    $insert_service_query = "INSERT INTO service (`Service_Date`, `Type_of_Service`,  `S_Time`, `E_Time`, `Parts_Used`, `Item_Cost`, `Service_Charge`, `Total_Cost`, `Mechanic_Id`, `User_Id`)
                              VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

    $stmt_add_service = mysqli_prepare($connect, $insert_service_query);
    mysqli_stmt_bind_param($stmt_add_service, "sssssdddss", $formatted_service_date, $type_of_service,  $start_time, $end_time, $parts_used, $item_cost, $service_charge, $total_cost,  $mechanic_id, $user_id);
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="Sales_Date" name="Sales_Date" required value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d'); ?>" max="<?php echo date('Y-m-d'); ?>" onchange="fetchServiceInformation()">
                                    </div>
