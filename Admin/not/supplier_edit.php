...
if (isset($_POST['update_btn'])) {
    ...
    mysqli_stmt_bind_param($stmt, "ssssi", $supplier_name, $brand, $updated_contact, $manager_id, $edit_id);
    mysqli_stmt_execute($stmt);
            ...
            <div id="content">
                <div class="container-fluid center-form">
                    <div class="form-container">
                        ...
                        <!-- Go Back Button -->
                        <a href="supplier.php" class="btn btn-secondary go-back-btn">Go Back</a>
